function evnt = NeuralFindEvent_Trigger_NAPLab(datapath, soundpath, subject, blocks, audchannel, troubleshoot)
% evnt = NeuralFindEvent_Trigger_Trigger_NAPLab(datapath, soundpath, subject, blocks, audchannel, troubleshoot)
...
%           default: 1
%       troubleshoot: logical, if 1, will pause at each step to plot and
%           play alignment for use to evaluate
%
% Result:       
