function evnt = NeuralFindEvent_Trigger (datapath, soundpath, subject, blocks, audchannel, troubleshoot)
...
for i = 1:length(blocknames)
    ...
    savespecgram = input('Do you want to save the aligned spectrogram? ');
