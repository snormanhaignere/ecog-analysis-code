...
tic, [modelParamsDF, optOptions] = strfOpt(modelParams, trainingIndex, optOptions); toc
...
tic, [modelParamsGradDesc, optOptions] = strfOpt(modelParams, trainingIndex, optOptions, earlyStoppingIndex); toc
...
tic, [modelParamsCoorDesc, optOptions] = strfOpt(modelParams, trainingIndex, optOptions, earlyStoppingIndex); toc
...
for k = 1:length(validationGroups)
    ...
    [modelParamsDF2, resp1] = strfFwd(modelParamsDF, gIndx);
