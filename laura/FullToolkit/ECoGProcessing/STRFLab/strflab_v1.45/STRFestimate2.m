function [strf, opt] = STRFestimate2(stim,resp,fs,params)
...
if ~exist('params','var') || length(params)<4
    switch STRFMethod
        case 'DirectFit'
            tolerance = [100 50 10 5 1 .5 .1 .05]/1000;
    end
else
    switch STRFMethod
        case 'DirectFit'
    ...
    case 'DirectFit'
        ...
        switch xvalFlag(1)
            case 0,
                ...
                optOptions.tolerances = tolerance;
                ...
                opt.bestTol = modelParamsDF.bestTol;
                opt.bestSparseness = modelParamsDF.bestSparseness;
                opt.bestInfoVal = modelParamsDF.bestInfoVal;
            case 1
                ...
                for cnt1 = 1:length(stim)/trnper
                    ...
                    opt(cnt1).bestTol           = modelParamsDF.bestTol;
                    opt(cnt1).bestSparseness    = modelParamsDF.bestSparseness;
                    opt(cnt1).bestInfoVal       = modelParamsDF.bestInfoVal;
                    % now predictions:
