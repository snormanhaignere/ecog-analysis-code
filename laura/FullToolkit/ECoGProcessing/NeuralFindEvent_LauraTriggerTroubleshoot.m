...
for i = 1:length(blocknames)
    ...
    if exist(StimPath,'file')
        ...
        audioRecord = resample(w,upsample,downsample);
...
%             w2 = resample(w,audioRecordFreq,fs_audio);
        ...
        %% Find the next trigger location! NEW
        ...
        if exist(StimPath,'file')
            ...
            if troubleshoot
                ...
                soundsc(recordResamp,audioRecordFreq*2); soundsc(waveResamp,audioRecordFreq*2);
                keyboard
            end
    ...
    if exist(StimPath,'file')
        ...
        plot(wholerecord,'b'); hold on; plot(wholewaveform,'r'); plot(trigger,'k');
