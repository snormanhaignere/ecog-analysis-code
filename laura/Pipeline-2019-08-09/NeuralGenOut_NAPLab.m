function [out] = NeuralGenOut_NAPLab(datapath, cond, subject, blocks, channels, audchannels, dataf, befaft, specflag, datatype, normout, evntpart, artifact)
...
%       dataf (optional): specify desired data fs; if empty, no resampling
%       befaft (optional): amount of silence to insert before /after each
%           evnt, in seconds
%           default: [0.5 0.5] aka one second before and after
...
%           default: 'ECoG'
%       normout (optional): if true, z-scores out structure by channel
%       evntpart (optional): can select only part of evnt to include
